...
// var info = ("NAME: "+ cardname +"<br>"+ "CARD NUMBER: " + cardno + "<br>" + "EXPIRATION DATE: " + expdate + "<br>" +"SECURITY CODE: " + seccode);
...
// });
            ...
            alert('PLEASE COME AGAIN, ENJOY YOUR FOOD(S) AND DRINK(S) :D ')
